...
public class IterateSequentialPropertySavingTestCase extends ESBIntegrationTest {
    ...
    public void setEnvironment() throws Exception {
        super.init();
        addProxyService(ESBTestCaseUtils.loadResource("/artifacts/ESB/mediatorconfig/iterate/iterateSequentialTruePropertyWithOutProperty.xml"));
    ...
    public void testSavingSequentialTrueProperty() throws Exception {
        proxyServiceAdminClient.updateProxy(ESBTestCaseUtils.loadResource("/artifacts/ESB/mediatorconfig/iterate/iterateSequentialTrueProperty.xml"));
